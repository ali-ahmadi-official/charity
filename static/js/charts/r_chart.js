...
pieChartCreator(parseCountsFromPercent(results['previous_donation']), 'previous_donation');
pieChartCreator(parseCountsFromPercent(results['medical_urgency']), 'medical_urgency');
pieChartCreator(parseCountsFromPercent(results['candidate_for_2_kidney_TX']), 'candidate_for_2_kidney_TX');

pieChartCreator(parseCountsFromPercent(results['candidate_for_kidney_after_other_organ_TX']), 'candidate_for_kidney_after_other_organ_TX');
pieChartCreator(parseCountsFromPercent(results['cpra']), 'cpra');
pieChartCreator(parseCountsFromPercent(results['desensitized']), 'desensitized');

barChartCreator(parseCountsFromPercent(results['hla_a_uam']), 'hla_a_uam', 'HLA A UAM');
barChartCreator(parseCountsFromPercent(results['hla_b_uam']), 'hla_b_uam', 'HLA B UAM');

barChartCreator(parseCountsFromPercent(results['hla_drb1_uam']), 'hla_drb1_uam', 'HLA DRB1 UAM');
barChartCreator(parseCountsFromPercent(results['hla_drb_uam']), 'hla_drb_uam', 'HLA DRB UAM');
barChartCreator(parseCountsFromPercent(results['hla_dqb1_uam']), 'hla_dqb1_uam', 'HLA DQB1 UAM');